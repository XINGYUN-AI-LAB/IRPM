...
#if [ "$JOB_COMPLETION_INDEX" = 0 ] ; then
#MODEL_PATH=
EXP_NAME=steer3_filter-prompt4-b96-lr5e6-score-060-llama31-ada1-8B-critique-6e6
DATASET=${train_data}
...
python3 -m verl.trainer.main_ppo \
    ...
    custom_reward_function.name=compute_score_batched_score_mean_adaptive_pre_llama \

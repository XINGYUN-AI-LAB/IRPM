                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("reward", timing_raw, color="yellow"):
                        ...
                        if self.config.reward_model.launch_reward_fn_async:
                            ...
                            metrics.update({f"training/{k}_mean": np.nanmean(v) for k, v in reward_extra_infos_dict.items()})
                            metrics.update({f"training/{k}_std": np.nanstd(v) for k, v in reward_extra_infos_dict.items()})

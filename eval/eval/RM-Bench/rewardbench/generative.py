...
DX_SINGLE_TURN_USER_PROMPT4="""# Role Definition
...
DX_SINGLE_TURN_USER_PROMPT7 = r"""# Role Definition
You are an expert AI evaluator. Your task is to provide a comprehensive, objective, and structured evaluation of an AI model's [Response] based on the user's [Context].
...
def format_judge_answers(question, answer_a, answer_b, multi_turn=False, model_modifier=None):
    ...
    #         return system_prompt, user_prompt1, user_prompt2
        ...
        if multi_turn:
            ...
            system_prompt = "You are Qwen, created by Alibaba Cloud. You are a helpful assistant."
            user_prompt1 = DX_SINGLE_TURN_USER_PROMPT4.format(
                context=question,
                response=answer_a[1]["content"],
            )
            user_prompt2 = DX_SINGLE_TURN_USER_PROMPT4.format(
                context=question,
                response=answer_b[1]["content"],
            )
            return system_prompt, user_prompt1, user_prompt2
        ...
        if multi_turn:
            ...
            system_prompt = "You are Qwen, created by Alibaba Cloud. You are a helpful assistant."
            user_prompt1 = DX_SINGLE_TURN_USER_PROMPT7.format(
                context=question,
                response=answer_a[1]["content"],
            )
            user_prompt2 = DX_SINGLE_TURN_USER_PROMPT7.format(
                context=question,
                response=answer_b[1]["content"],
            )
            return system_prompt, user_prompt1, user_prompt2

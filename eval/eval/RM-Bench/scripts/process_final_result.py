...
if args.meta_result_save_dir is None: 
    ...
    output_dir = f"{args.meta_result_save_dir}/{args.model_save_name}/rm-bench/"

print("output_dir", output_dir)

output_path1 = os.path.join(output_dir, f"total_dataset_1_{args.mode}.json")
output_path2 = os.path.join(output_dir, f"total_dataset_2_{args.mode}.json")
output_path3 = os.path.join(output_dir, f"total_dataset_3_{args.mode}.json")

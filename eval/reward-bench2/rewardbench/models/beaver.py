...
try:
    ...
    # Newer versions of transformers don't have these docstring constants
...
class LlamaForScore(ScoreModelMixin, LlamaPreTrainedModel):
    ...
    @replace_return_docstrings(output_type=ScoreModelOutput, config_class=_CONFIG_FOR_DOC if _CONFIG_FOR_DOC else PretrainedConfig)
